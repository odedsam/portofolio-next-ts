...
export default function HeroSection() {
  return (
    <section className="w-full my-48 sm:mt-56 mb-24 flex flex-col gap-4 items-center justify-center text-center space-y-4 md:space-y-14 px-6 dark:main-gradient">
      ...
      <div className="flex flex-col items-center max-w-5xl">
        <p className="text-sm xl:text-lg drop-shadow-lg sm:max-w-2xl font-sans tracking-tight font-semibold">
