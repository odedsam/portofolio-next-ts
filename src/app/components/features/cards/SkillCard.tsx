...
export default function SkillCard(skils: SkillProps) {
  return (
      ...
      <div className="p-4 border border-gray-700 rounded-lg">
        <div className="g-white bg-opacity-20 backdrop-blur-lg p-6 rounded-xl shadow-xl border  border-opacity-30 hover:scale-105 transition duration-300 shadoe-neon border-pink-500">
