...
export const PROJECTS: Project[] = [
  {
    ...
    tech: ['Nuxt 3', 'Vue', 'Tailwind', 'Supabase'],
  ...
  },
  {
    ...
    github: 'https://github.com/yourusername/avion-store',
  },
  {
    title: 'Hasa Media',
    description: 'Media services agency website with CMS-managed content and service showcase.',
    tech: ['React', 'CMS', 'Responsive Design'],
    href: 'https://hasamedia.io',
    github: 'https://github.com/yourusername/media-agency',
  },
  {
    title: 'Synapso CRM',
  ...
  },
  {
    ...
    href: 'https://your-crypto-app.vercel.app',
