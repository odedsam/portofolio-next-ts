        ...
        <div className="text-base-content">
          {loading || !profile ? (
            ...
            <Fragment>
              ...
              {social?.x && <ListItem icon={<SiX />} title="X:" value={social.x} link={`https://x.com/${social.x}`} />}
              {social?.mastodon && (
                <ListItem
                  icon={<FaMastodon />}
                  title="Mastodon:"
              ...
              {social?.dev && <ListItem icon={<FaDev />} title="Dev:" value={social.dev} link={`https://dev.to/${social.dev}`} />}
